#install packages to read  .txt
  ...
  library(data.table)
#read the datasets
  subjectTrain   <- read.table("C:/Users/Dzeine/Desktop/UCI HAR Dataset/train/subject_train.txt")
  activityTrain  <- read.table("C:/Users/Dzeine/Desktop/UCI HAR Dataset/train/y_train.txt")
  featuresTrain  <- read.table("C:/Users/Dzeine/Desktop/UCI HAR Dataset/train/X_train.txt")
  subjectTest    <- read.table("C:/Users/Dzeine/Desktop/UCI HAR Dataset/test/subject_test.txt")
  activityTest   <- read.table("C:/Users/Dzeine/Desktop/UCI HAR Dataset/test/y_test.txt")
  featuresTest   <- read.table("C:/Users/Dzeine/Desktop/UCI HAR Dataset/test/X_test.txt")
  featureNames   <- read.table("C:/Users/Dzeine/Desktop/UCI HAR Dataset/features.txt")
  activityLabels <- read.table("C:/Users/Dzeine/Desktop/UCI HAR Dataset/activity_labels.txt")
...
#4. Appropriately labels the data set with descriptive variable names. 
  ...
  names(extracted)<-gsub("\\(\\)", "", names(extracted))
  names(extracted)<-gsub("^", "MeanOf", names(extracted))
